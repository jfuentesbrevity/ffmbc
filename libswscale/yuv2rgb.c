...
{\
    int y;\
    int vshift = c->srcFormat != PIX_FMT_YUV422P;\
\
...
SwsFunc ff_yuv2rgb_get_func_ptr(SwsContext *c)
{
    ...
    case PIX_FMT_ARGB:
    case PIX_FMT_ABGR:       if (CONFIG_SWSCALE_ALPHA && (c->srcFormat == PIX_FMT_YUVA420P || c->srcFormat == PIX_FMT_YUVA422P)) return yuva2argb_c;
    case PIX_FMT_RGBA:
    case PIX_FMT_BGRA:       return (CONFIG_SWSCALE_ALPHA && (c->srcFormat == PIX_FMT_YUVA420P || c->srcFormat == PIX_FMT_YUVA422P) ) ? yuva2rgba_c : yuv2rgb_c_32;
